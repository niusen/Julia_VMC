...
const Ly = 10      # number of sites along y / number of rows in the lattice
const Lx = 10      # number of sites along x / number of columns in the lattice
...
# Boundary conditions
const theta_bc_right = Lx * (1.0000 * pi / Lx)
const theta_bc_down = 0.000 * (1.00 * pi / Lx)
